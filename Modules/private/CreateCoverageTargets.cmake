...
function(_create_coverage_targets_impl)
  ...
  add_custom_target(
    ...
    COMMAND ${CMAKE_COMMAND} -E rm -rf
            "${PROJECT_SOURCE_DIR}/.coverage-generated"
    COMMAND ${CMAKE_COMMAND} -E make_directory
            "${PROJECT_SOURCE_DIR}/.coverage-generated"
    # NOTE: Actual symlink creation logic should be implemented here if needed
    # (e.g., via a script)
    WORKING_DIRECTORY ${CMAKE_BINARY_DIR}
  ...
  if(GCOVR_EXECUTABLE)
    ...
    foreach(_gcovr_filter_path IN LISTS _gcovr_filter_paths)
      ...
      string(REGEX REPLACE "([][.^$+*?()|\\])" "\\\\\\1" _gcovr_filter_escaped
