...
TEST_CASE("Call multiple functions", "[programming model]")
{
  ...
  {
    g.with("square_numbers", square_numbers, concurrency::unlimited).transform("numbers").to("squared_numbers");
    g.with("sum_numbers", sum_numbers, concurrency::unlimited).transform("squared_numbers").to("summed_numbers");
