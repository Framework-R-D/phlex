...
namespace phlex::experimental {
  ...
  public:
    static end_of_message_ptr make_base(data_layer_hierarchy* hierarchy, data_cell_id_ptr id);
    end_of_message_ptr make_child(data_cell_id_ptr id);
    ~end_of_message();

  private:
    end_of_message(end_of_message_ptr parent, data_layer_hierarchy* hierarchy, data_cell_id_ptr id);
