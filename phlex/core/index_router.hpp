...
namespace phlex::experimental {
  ...
  public:
    ...
    struct unfold_data {
      ...
      std::map<identifier, std::size_t> count_per_input_layer;
    };
  ...
  private:
    ...
    void establish_layer_hierarchy(std::vector<layer_path> layer_paths_from_driver,
    ...
    std::pair<detail::multilayer_slots_ptr, detail::end_token_entries_ptr> multilayer_slots_for(
    ...
    identifier deepest_layer_name(std::vector<identifier> const& layer_names) const;
    ...
    std::vector<layer_path> sorted_layer_paths_;
    ...
    tbb::concurrent_unordered_map<identifier, detail::join_node_slots> multilayer_join_slots_;
    ...
    struct multilayer_slot_cache_entry {
      ...
      detail::end_token_entries_ptr end_token_entries;
    };
