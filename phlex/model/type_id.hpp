...
struct fmt::formatter<phlex::experimental::type_id> : formatter<std::string> {
  constexpr auto format(phlex::experimental::type_id type, format_context& ctx) const;
};

constexpr auto fmt::formatter<phlex::experimental::type_id>::format(
  phlex::experimental::type_id type, format_context& ctx) const
{
