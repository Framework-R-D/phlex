...
Storage_Write_Container::Storage_Write_Container(std::string const& name) : m_name(name), m_file(nullptr) {}
...
void Storage_Write_Container::setAttribute(std::string const& /*name*/, std::string const& /*value*/)
{
