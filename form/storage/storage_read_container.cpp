...
Storage_Read_Container::Storage_Read_Container(std::string const& name) : m_name(name), m_file(nullptr) {}
...
bool Storage_Read_Container::read(int /* id*/, void const** /*data*/, std::type_info const& /* type*/)
{
  return false;
}
